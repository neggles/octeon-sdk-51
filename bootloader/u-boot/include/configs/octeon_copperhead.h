...
#define COPPERHEAD_DEF_DRAM_FREQ		800
...
/** The Copperhead board does not have a MCU */
#define BOARD_MCU_AVAILABLE		0

/** i2c eeprom address */
#define CONFIG_SYS_I2C_EEPROM_ADDR	OCTEON_COPPERHEAD_BOARD_EEPROM_TWSI_ADDR
...
#define CONFIG_PHY_BROADCOM		/** Enable Broadcom PHY support */

/** Identify card for PXE booting */
#define CONFIG_BOOTP_VCI_STRING		"CaviumPXE:copperhead:000000"
...
/**
 * DTT sensor
 * The COPPERHEAD has a SA56004X
 *
 * NOTE: This sensor sits behind a mux and is normally invisible to Octeon.
 */
#define CONFIG_SYS_I2C_DTT_ADDR		0x4C

/* Include shared board configuration, consisting mainly of DRAM details. */
#include "octeon_copperhead_shared.h"
...
#define CONFIG_CMD_OCTEON_VPD			/** Enable SSD VPD command */
#define CONFIG_SYS_SSD_VPD_BUS		0
#define CONFIG_SYS_SSD_VPD_ADDR		0x53
